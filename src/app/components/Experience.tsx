        ...
        <div className=" md:p-6 p-0">
            <div>
                ...
                <div className="box-content m-auto bg-blue bg-opacity-10 m4 text-black mb-5 border-[0.5px] border-black hover:shadow-xl ">
                    ...
                    <li>Engaged with clients to understand requirements, provide Tech bg="blue"nical recommendations, and deliver customised solutions that meet their business needs.</li>
                    <br />
                ...
                <div className="box-content m-auto bg-blue bg-opacity-10 m4 text-black mb-5 border-[0.5px] border-black hover:shadow-xl ">
                    ...
                    <div className="font-mono text-left text-sm md:text-lg px-4 py-2">
                    <li>Developed a website for the Cybersecurity club at RMIT.</li>
